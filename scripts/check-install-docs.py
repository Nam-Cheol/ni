...
PINNED_MAC_INSTALL = f"{LATEST_MAC_INSTALL} --version 0.6.4"
...
REQUIRED_MARKERS = {
    ...
    "docs/22_INSTALL.md": [
        ...
        LATEST_MAC_INSTALL,
        "The public v0.6.4 macOS curl installer path is verified",
        "For reproducible v0.6.4 checks",
        "VERSION=\"0.6.4\"",
    ...
    "docs/install-curl.md": [
        "Status: Available for the verified v0.6.4 macOS `namba-intent` path.",
    ...
    "docs/install-curl.ko.md": [
        "Status: verified v0.6.4 macOS `namba-intent` path는 Available이다.",
        "curl -fsSL https://raw.githubusercontent.com/Nam-Cheol/ni/main/install.sh | sh -s -- --update-path --version 0.6.4",
