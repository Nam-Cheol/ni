...
PINNED_MAC_INSTALL = f"{LATEST_MAC_INSTALL} --version 0.6.3"
...
REQUIRED_MARKERS = {
    "README.md": [
        ...
        "v0.6.3 is the current published Namba Intent release.",
        "### macOS",
        "### Windows",
        LATEST_MAC_INSTALL,
        "namba-intent --help",
    ...
    "README.ko.md": [
        ...
        "v0.6.3는 current published Namba Intent release입니다.",
        "### macOS",
        "### Windows",
        LATEST_MAC_INSTALL,
        "namba-intent --help",
    ...
    "docs/22_INSTALL.md": [
        ...
        LATEST_MAC_INSTALL,
        "The public v0.6.3 macOS curl installer path is verified",
        "For reproducible v0.6.3 checks",
        "VERSION=\"0.6.3\"",
    ...
    "docs/install-curl.md": [
        "Status: Available for the verified v0.6.3 macOS `namba-intent` path.",
    ...
    "docs/install-curl.ko.md": [
        "Status: verified v0.6.3 macOS `namba-intent` path는 Available이다.",
        "curl -fsSL https://raw.githubusercontent.com/Nam-Cheol/ni/main/install.sh | sh -s -- --update-path --version 0.6.3",
