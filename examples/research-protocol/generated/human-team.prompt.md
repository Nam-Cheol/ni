...
Risks:
- RISK-001 (high): Require explicit inclusion and exclusion criteria plus an independent reviewer reproduction check before fieldwork.
- RISK-002 (high): Separate environmental observation from participant contact and require ethics review before collecting personal data.
- RISK-003 (medium): Lock variables, comparison method, exclusion criteria, and reproducibility evidence in the protocol before execution.
