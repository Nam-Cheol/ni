...
Verified Namba Intent release path를 재현하려면 `--version 0.6.4`을 사용한다.
...
v0.6.4 macOS installer path는 real release verification을 거쳤다. 이후 release에서는
...
통과했다. v0.6.4 macOS verification은
[`143_V0_6_4_POST_RELEASE_VERIFICATION.ko.md`](143_V0_6_4_POST_RELEASE_VERIFICATION.ko.md)에
