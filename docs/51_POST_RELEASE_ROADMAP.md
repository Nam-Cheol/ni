...
This roadmap defines the next phases after the verified v0.5.1 release,
...
For the v0.5.1 post-release verification, use
[`132_V0_5_1_POST_RELEASE_VERIFICATION.md`](132_V0_5_1_POST_RELEASE_VERIFICATION.md)
to preserve the actual release URL, hosted asset inventory, checksum proof,
...
to preserve the pre-publication release-note decision, the
complete rename release notes draft, migration notes, NambaAI distinction,
claim-boundary audit, known deferrals, and the pre-release claim boundaries.

For the v0.6.0 post-release verification, use
[`140_V0_6_0_POST_RELEASE_VERIFICATION.md`](140_V0_6_0_POST_RELEASE_VERIFICATION.md)
to preserve the release commit, tag, GitHub Release URL, asset inventory,
checksum proof, darwin/arm64 artifact proof, isolated `install.sh --version
0.6.0` verification, public install parity closure, and remaining deferrals.
