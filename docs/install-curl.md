...
Status: Available for the verified v0.6.2 macOS `namba-intent` path. The
...
For the verified v0.6.2 macOS install:
...
Use `--version 0.6.2` when you want to reproduce the verified Namba Intent
...
The v0.6.2 macOS installer path has real release verification. For later
...
release assets. The v0.6.2 macOS verification is recorded in
